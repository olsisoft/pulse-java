...
//
// Unlike Main (pulse-java SDK), this uses the engine SDK
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (StreamFlowClient client =
            ...
            System.out.println("Produced " + recs.size()
                    ...
                    + host + ":" + port + ").");
            System.out.println("Read the modernized output with `Main read "
                    + "modernized-events` or query the SQL sink table.");
        }
    }
